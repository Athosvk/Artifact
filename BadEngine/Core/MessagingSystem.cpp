...
void BadEngine::MessagingSystem::dispatchQueue(MessageQueue& a_MessageQueue)
{
...
void BadEngine::MessagingSystem::sendMessage(GameObject a_Target, const Message* a_Message, 
